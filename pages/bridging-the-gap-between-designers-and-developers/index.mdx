...
Before we dive into the great things we did as a team when building [Teleport 4.3](https://goteleport.com/), I’d like to quickly touch on the fundamental differences between designers and developers for those who may not be familiar with these roles and why there is a natural conflict. These differences are not set in stone, but include more of a general description of how designers and developers think differently about the same thing.
...
Below are a handful of strategies to bridge the gap between designers and engineers and create stronger, happier, and more effective teams. We used these techniques for collaborative success while building [Teleport 4.3](https://goteleport.com/) and we continue to use them everyday.
...
We recently shipped [Teleport 4.3](https://goteleport.com/), a new version of Teleport that was packed full of features including an improved UI that allows us to surface features that were hidden. Best of all, 4.3 is flexible enough to add new features in the future. See the [Teleport demo of the new UI](https://goteleport.com/resources/videos/teleport-43-shortdemo/).
...
To conclude this article I’d like to present [Teleport 4.3](https://goteleport.com/),  a true labor of love from a team that is passionate about creating amazing products. Thanks for reading and good luck building amazing teams and amazing products. Enjoy!
...
This is just a brief highlight of some new features in [Teleport 4.3](https://goteleport.com/). Watch a short [demo of Teleport](https://goteleport.com/resources/videos/teleport-43-shortdemo/) and try out Teleport 4.3 for free by [downloading it today](https://goteleport.com/download/). Enjoy!
