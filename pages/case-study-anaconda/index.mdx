...
To accomplish this, Anaconda turned to [Gravity](https://goteleport.com/), an open-core Kubernetes packaging solution that takes the drama out of deploying applications into [multi-cloud](https://goteleport.com/features/) or on-premise environments.  Gravity makes it possible to run, access, and distribute Kubernetes-based applications consistently for customers who want to run applications in restricted or highly secure environments.
