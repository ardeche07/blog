...
Part of [embracing Zero Trust](/workflow-api/) is to use tools that meet security requirements without disrupting (and sometimes even improving) business flow.
