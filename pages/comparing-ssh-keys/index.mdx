...
<figure>
  ...
  <figcaption>
    <a href="https://en.wikipedia.org/wiki/Public-key_cryptography#/media/File:Public_key_encryption.svg">
      Figure 2: Only Alice’s private key can decrypt a message signed with
      Alice’s public key
    </a>
  </figcaption>
</figure>
...
<table
  ...
  css={css({
    ...
    marginBottom: "40px",
    "tr > th": { padding: "10px" },
    "tr > td": { fontSize: "10px", padding: "10px" },
  })}
>
  <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <a href="https://mathworld.wolfram.com/QuadraticSieve.html">
        Quadratic Sieve
      </a>{" "}
      and{" "}
...
>
  <tr>
    ...
    <td>
      ...
      <a href="https://en.wikipedia.org/wiki/Comparison_of_cryptography_libraries">
  ...
  <tr>
    ...
    <td>
      ...
      <a href="https://www.openssh.com/legacy.html">disables</a> DSA by default.
    </td>
  </tr>
  <tr>
    <th>Performance</th>
    <td>
      <a href="https://security.stackexchange.com/questions/97411/significance-of-the-difference-between-dsa-and-rsa-in-signature-verifying-speed">
  ...
  <tr>
    ...
    <td>
      ...
      value that,{" "}
      <a href="https://rdist.root.org/2010/11/19/dsa-requirements-for-random-k-value/">
        {" "}
        if discovered
      </a>
      , can reveal the private key.
    </td>
  </tr>
</table>
...
>
  <tr>
    ...
    <td>
      EdDSA is fairly new.
      <a href="https://en.wikipedia.org/wiki/Crypto%2B%2B#Algorithms">
        Crypto++
      </a>{" "}
      and{" "}
      <a href="https://en.wikipedia.org/wiki/Cryptlib#Algorithm_support">
        cryptlib
      </a>
      do not currently support EdDSA.
    </td>
  </tr>
  <tr>
    <th>Compatibility</th>
    <td>
      Compatible with newer clients, Ed25519 has seen the{" "}
      <a href="https://ianix.com/pub/ed25519-deployment.html#ed25519-libraries">
        largest adoption
      </a>
      among the Edward Curves, though NIST also proposed Ed448 in their recent draft
      of <a href="https://www.nist.gov/news-events/news/2019/10/digital-signatures-and-elliptic-curve-cryptography-request-comments-draft">
        SP 800-186
      </a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      EdDSA provides the{" "}
      <a href="https://ed25519.cr.yp.to/">highest security level </a>compared to
