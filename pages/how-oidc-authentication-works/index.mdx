...
<Box mx="auto">
  <figure>
    <BlogImage height={500} width={281} src="./assets/oidc-1.png" alt="Federated Identity" />
...
<figure>
  <BlogImage height={316} width={680} src="./assets/oidc-2.png" alt="Authentication vs Authorization" width="100%"/>
...
<figure>
  <BlogImage height={195} width={680}src="./assets/oidc-3.png" alt="SAML vs OAuth2 vs OIDC Comparison" width="100%"/>
...
<figure>
  <BlogImage height={442} width={680}src="./assets/oidc-4.png" alt="Bob Delegating Spotify Access to his Facebook Profile" width="100%"/>
...
<figure>
  <BlogImage height={272} width={680} src="./assets/oidc-5.png" alt="OIDC Workflow" width="100%"/>
...
<figure>
  <BlogImage height={272} width={680} src="./assets/oidc-6.png" alt="Optional OIDC Standard Scopes" width="100%"/>
...
<figure>
  <BlogImage height={365} width={680} src="./assets/oidc-7.png" alt="OIDC Authorization Code Grant Flow" width="100%"/>
